                                    ...
                                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content<?= $count ?>" aria-labelledby="home-tab">
                                        ...
                                        <?php
                                            ...
                                            foreach ($table_value as $row => $row_value){
                                                ...
                                                ?>
                                                <td style="text-align: center; width: 4%"><a href="<?=base_url('admin/uyeler/set_update/admin/')?>" class="btn btn-info btn-xs" style="margin-bottom: 0px; margin-right: 0px"><i class="fa fa-pencil"></i> Edit </a></td>
                                                <td style="text-align: center; width: 4%"><a href="<?=base_url('admin/uyeler/delete/admin/')?>" class="btn btn-danger btn-xs" style="margin-bottom: 0px; margin-right: 0px"><i class="fa fa-trash-o"></i> Delete </a></td>
                                                </tr>
                                                <?php
